...
public class AudioBook implements BookProduct
{
    ...
    public AudioBook(int id, BookType bookType, String title, double price, String author, String publisher,
                     int pageAmount, Genre genre, boolean hasVoiceActor, String description, String image)
    {
        ...
        this.setGenre(genre);
        this.setHasVoiceActor(hasVoiceActor);
    ...
    public void setHasVoiceActor(boolean hasVoiceActor)
    {
